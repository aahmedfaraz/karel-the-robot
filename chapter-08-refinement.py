...
# is the strategy of top-down design or stepwise refinement, 
# which consists of solving problems by starting with the problem as a whole. 
# You break the whole problem down into pieces, and then solve each piece, 
# breaking those down further if necessary. 
# This top down strategy is complemented with iterative testing 
# where you make sure that the smaller pieces of the solution are working before moving on.
